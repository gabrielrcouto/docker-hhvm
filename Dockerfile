...
RUN apt-get update
RUN apt-get install -y --force-yes xorg libssl-dev libxrender-dev libjpeg8-dev libjpeg8 fontconfig ttf-mscorefonts-installer xfonts-75dpi curl mysql-client-5.5 php7.0-cli php7.0-curl php7.0-gd php7.0-intl php7.0-mysql php7.0-mcrypt php-memcached
